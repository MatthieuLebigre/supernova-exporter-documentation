...
export function generateCustomCSSHash(configuration: any): string {
  ...
  const selectedKeys = [
    ...
    'lookAndFeelAccentInkColor',
    'lookAndFeelAccentSurfaceColor',
    'lookAndFeelInkPrimaryColor',
    'lookAndFeelInkSecondaryColor',
    'lookAndFeelInkTertiaryColor',
    'lookAndFeelInkInvertedColor',
    'lookAndFeelPageBackgroundColor',
    'themeConfiguration',
    'siteMaxWidth',
